...
public class Test {
	...
	public static void ready() {
		//TODO DB Connection
		SignatureVoiceMap.put("¸ø¸ÂÃèÁö·Õ", "Hello");
		SignatureVoiceMap.put("¾Ó±â¸ğÂî", "Hello");
		pattern = Pattern.compile("(¸ø¸ÂÃèÁö·Õ|¾Ó±â¸ğÂî)");
	...
	public static void main(String[] args) {
		ready();
		String str = "¤»¤»¤©¤³¤³¸ø¸ÂÃèÁö·Õ¿¡º£º£¤»¤»¤©¤³¤³¸ø¸ÂÃèÁö·Õ¤»¤»¤©¤³¤³¾Ó±â¸ğÂî";
		for(SignatureString s : getSignatureSound(str)) {
			if(s.isSignatureString()) System.out.println("Signature - " + s.name);
			else System.out.println("Raw - " + s.content);
		}
	}
